...
Omnifin v0.7.0 supports creating the first administrator with Authentik from
...
Validate and enable one connector at a time. Omnifin v0.7.0 describes these as
